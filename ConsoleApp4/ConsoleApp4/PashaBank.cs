...
namespace ConsoleApp4
{
    internal class PashaBank:Card
    {
        ...
        public PashaBank(string name, string surname, string cardNumber, int cVV, decimal balance, decimal perIncrease, decimal perExtract) : base(name, surname, cardNumber, cVV, balance)
        {
